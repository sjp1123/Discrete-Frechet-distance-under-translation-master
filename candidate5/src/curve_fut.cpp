...
auto Curve::getExtremePoints() const -> ExtremePoints
{
	return { extreme_points.min_x + tau.x, extreme_points.min_y + tau.y,
	         extreme_points.max_x + tau.x, extreme_points.max_y + tau.y };
}
