...
public:
	...
	virtual bool lessThanWithFilters(distance_t distance, Curve const& curve1, Curve const& curve2) = 0;
	virtual distance_t calcDistance(Curve const& curve1, Curve const& curve2) = 0;
